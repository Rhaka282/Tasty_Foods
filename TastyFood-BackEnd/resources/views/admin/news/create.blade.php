                ...
                <div class="p-8 text-gray-900">
                    <form action="{{ route('admin.news.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" class="w-full rounded-xl border-gray-200 focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50 transition-shadow py-3 px-4 text-sm font-semibold" placeholder="Masukkan judul berita yang menarik" value="{{ old('title') }}" required>
                        </div>

                        <!-- Content -->
                        <div>
                            <label for="content" class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">Konten / Isi Berita</label>
                            <textarea name="content" id="content" rows="8" class="w-full rounded-xl border-gray-200 focus:border-amber-500 focus:ring focus:ring-amber-200 focus:ring-opacity-50 transition-shadow py-3 px-4 text-sm" placeholder="Tuliskan isi artikel lengkap di sini..." required>{{ old('content') }}</textarea>
                        </div>

                        <!-- Image -->
                        <div>
                            <label for="image" class="block text-sm font-bold text-gray-700 uppercase tracking-wider mb-2">Gambar Sampul</label>
                            ...
                            <div id="preview-container" class="mt-4 hidden text-center">
                                <p class="text-xs text-gray-400 mb-2">Pratinjau Gambar:</p>
